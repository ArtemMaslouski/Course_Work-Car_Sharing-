...
namespace CarSharing
{
    public partial class MainWindow : Form
    {
        ...
        {
            GMapOverlay myPosition = new GMapOverlay("Мое местоположение");
            ...
            gMapControl1.Zoom = 4;
            gMapControl1.Position = new GMap.NET.PointLatLng(53.896651, 27.555887);
            ...
            //К основному полигонц добавляем дополнительно созданные
            gMapControl1.Overlays.Add(poligon);
